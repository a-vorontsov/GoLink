angular.module('app.services', [])
  ...
  .service('userDataService', function ($window) {
    ...
    this.getDisplayName = function () {
      if (data.id === null && $window.localStorage.getItem('display-name') !== null) {
    ...
    this.getTeam = function () {
      if (data.id === null && $window.localStorage.getItem('team') !== null) {
    ...
    this.getFriendCode = function () {
      if (data.id === null && $window.localStorage.getItem('friend-code') !== null) {
    ...
    this.getRadius = function () {
      if (data.id === null && $window.localStorage.getItem('radius') !== null) {
    ...
    this.getLatitude = function () {
      if (data.id === null && $window.localStorage.getItem('latitude') !== null) {
        return $window.localStorage.getItem('latitude');
      }
      return +data.coordinates.latitude.toFixed(EXACT_PRECISION);
    };

    this.getLongitude = function () {
      if (data.id === null && $window.localStorage.getItem('longitude') !== null) {
        return $window.localStorage.getItem('longitude');
      }
      return +data.coordinates.longitude.toFixed(EXACT_PRECISION);
    };

    this.getFuzzyLatitude = function () {
      if (data.id === null && $window.localStorage.getItem('fuzzy-latitude') !== null) {
        return $window.localStorage.getItem('fuzzy-latitude');
      }
      return +data.coordinates.latitude.toFixed(FUZZY_PRECISION);
    };

    this.getFuzzyLongitude = function () {
      if (data.id === null && $window.localStorage.getItem('fuzzy-longitude') !== null) {
        return $window.localStorage.getItem('fuzzy-longitude');
      }
